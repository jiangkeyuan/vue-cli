...
// https://api.github.com/orgs/jiangkeyuan/repos
// 通过github接口获取模版列表

// 1.获取项目列表
const fetchRepoList = async () => {
  const { data } = await axios.get('https://api.github.com/users/jiangkeyuan/repos');
  return data;
};

// 获取项目的版本号
const fetchTagList = async (repo) => {
  const { data } = await axios.get(`https://api.github.com/repos/jiangkeyuan/${repo}/tags`);
  return data;                      
};
